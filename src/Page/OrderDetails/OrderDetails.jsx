            ...
            <div className="text-center  flex flex-col justify-center items-center ">
              ...
              <p className="p-3 rounded-md lg:my-2 my-1 w-fit border bg-[#D2C5A2] font-bold text-lg">
                ...
                <span className="font-semibold">
                  {orderDetails.coursePurchaseData.form_no}
                </span>
              </p>
            </div>
                ...
                <div className="space-y-1 w-full">
                  <div className="flex items-center justify-between">
                    ...
                    <p className="text-start">
                      {orderDetails.coursePurchaseData.name}
                    </p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Country :</p>
                  ...
                  <div className="flex items-center justify-between">
                    <p>Address :</p>
                    <p>{orderDetails.coursePurchaseData.present_address}</p>
                  </div>
                  <div className="flex items-center justify-between">
                    <p>Order Notes :</p>
                  ...
                  <div className="flex items-center justify-between">
                    <p>Mobile :</p>
                    <p>{orderDetails.coursePurchaseData.phone_no}</p>
                  </div>
                </div>
              </div>
